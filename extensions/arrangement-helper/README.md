...
| Control | Description |
|---|---|
| Preset buttons (INTRO, VERSE, …) | Append a pre-named section with a default color |
| Section name | Editable inline — click to rename |
| Bar count | Number of bars for the section (default 8) |
| Color swatch | Opens the color palette |
| Drag handle (⠿) | Reorder sections by dragging |
| × button | Remove a section |
