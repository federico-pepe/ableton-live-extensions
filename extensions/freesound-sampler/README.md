...
[⬇️ Download](../../download/Freesound-Sampler-0.3.4.ablx)
...
- **Visual results** — Each result shows a waveform thumbnail, recognizable Creative Commons license icons, and category/key/BPM at a glance
...
- **Persistent API key** — Save your Freesound API key once and reuse it every session
...
1. Get a free API key at [freesound.org/apiv2](https://freesound.org/apiv2).
2. Right-click any **Audio Track** (or an audio lane in Arrangement View) and choose **Find samples**.
3. Enter a search query (e.g., "drums", "pad", "vintage") and paste your API key.
4. Click **Search**, then press ▶ on any result to preview it.
5. Click a sound card to download and import the clip into your track.

> Downloads are 128kbps MP3 preview files — sufficient for sampling and sound design.

## Licensing & attribution

Sounds on Freesound are released under Creative Commons licenses. Some (e.g. CC-BY) require you to
credit the creator when you use them. This extension helps you comply:
...
- Open **Attributions** in the dialog and click **Copy attribution text** to copy credit lines
  (sound name, author, link, and license) for the sounds you've imported.

Always review the specific license of each sound at [freesound.org](https://freesound.org).
